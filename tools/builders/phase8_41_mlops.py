...
cells.append(md(r"""# Notebook 41 — MLOps
...
plt.savefig('/tmp/41_mlops.png', dpi=100, bbox_inches='tight')
plt.close()
print("Figure saved: /tmp/41_mlops.png")
"""))
...
build("phase8_production/41_mlops.ipynb", cells)
print("NB41 built.")
