"""Builder for Notebook 25B — Grounded Answer and Citation Evaluation."""
import os
import sys
...
cells = [
    md(r"""
    # 25B · Grounded Answer and Citation Evaluation
    ### Phase 5 — Separate retrieval success from answer success

    **Prerequisites:** 25A. **Estimated time:** 6–8 hours. The first answerer is
...
build("phase5_rag/25b_grounded_answer_evaluation.ipynb", cells)
