"""Builder for Notebook 03A — Data Workflow, EDA, Cleaning, Pandas, and SQL."""
import os
import sys
...
cells = [
    md(r"""
    # 03A · Data Workflow, EDA, Cleaning, Pandas, and SQL
    ### Phase 0 — From Mathematical Objects to Trustworthy Training Data
    ...
    **Prerequisites:** Notebooks 00A–00E and Phase 0 Notebooks 01–02. This is
...
build("phase0_foundations/03a_data_workflow_eda_cleaning.ipynb", cells)
