"""Builder for Notebook 32 — Planning and Tool Use."""
import os, sys
...
cells = [
    md(r"""
    # 32 · Planning and Tool Use
    ### Phase 6 — Agentic AI · *ML/AI Senior Mastery Curriculum*

    > Notebook 31 built a ReAct agent that decides what to do one step at a time.
    ...
    **Parallel execution**: nodes at the same topological level can run concurrently.
    ...
    code(r"""
    # 5b. CoT planning: agent reasons one step at a time (from Notebook 31).
    ...
    **Next:** `33 · Memory Systems` — how agents maintain state across many turns and
...
build("phase6_agents/32_planning_tool_use.ipynb", cells)
