"""Builder for Lesson PRE-01 — Mathematical Language and Arithmetic."""
import os
import sys
...
cells = [
    ...
    **Use and limit:** absolute value measures error size without cancellation.
    ...
    You are ready for Lesson PRE-02 when you can answer these without guessing:
    ...
    **Score:** 9–10 points means ready; 7–8 means review the missed subsection;
    below 7 means repeat the worked examples before Lesson PRE-02.
    </details>
    """),
]
...
build(
    "00_prerequisites/01_math_language_and_arithmetic.ipynb",
    cells,
)
