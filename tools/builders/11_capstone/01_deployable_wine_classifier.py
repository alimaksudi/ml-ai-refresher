"""Builder for Lesson CAP-01 — Deployable Real-Data ML Vertical Slice."""
import os
import sys
...
cells = [
    md(r"""
    # CAP-01 · Deployable Real-Data ML Vertical Slice
...
build("11_capstone/01_deployable_wine_classifier.ipynb", cells)
