"""NB48 — Production RAG Systems builder."""
import sys, os
...
plt.tight_layout()
plt.savefig('/tmp/nb48_production_rag.png', dpi=80, bbox_inches='tight')
plt.show()
print("Figure saved.")
"""),
...
if __name__ == "__main__":
    build("phase9_system_design/48_production_rag.ipynb", cells)
