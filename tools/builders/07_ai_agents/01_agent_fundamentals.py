"""Builder for Lesson AGT-01 — Agent Fundamentals."""
import os, sys
...
cells = [
    ...
    **Agent capabilities:**
    ...
    - `get_policy`: retrieves from policy knowledge base (Lessons RAG-01 through RAG-08).
    ...
    **Deep-dive questions**
    ...
    - *"What breaks when the context window fills up?"* → Old trajectory steps are
      ...
      key-value memory store; implement explicit memory (Lesson AGT-03).
    ...
    **Related lesson:** `AGT-02 · Planning and Tool Use` — how agents can plan multi-step tasks
    upfront (ReWOO, Tree-of-Thought) before executing, reducing errors from reactive
    step-by-step decision making.
    """),
]

build("07_ai_agents/01_agent_fundamentals.ipynb", cells)
