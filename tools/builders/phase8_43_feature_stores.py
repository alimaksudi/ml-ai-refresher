...
cells.append(md(r"""# Notebook 43 — Feature Stores
...
plt.savefig('/tmp/43_feature_stores.png', dpi=100, bbox_inches='tight')
plt.close()
print("Figure saved: /tmp/43_feature_stores.png")
"""))
...
build("phase8_production/43_feature_stores.ipynb", cells)
print("NB43 built.")
