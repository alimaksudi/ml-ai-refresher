"""Builder for Notebook 25A — Measured Baseline RAG Retrieval."""
import os
import sys
...
cells = [
    md(r"""
    # 25A · Measured Baseline RAG Retrieval
    ### Phase 5 — Establish evidence before infrastructure

    **Prerequisites:** 20–21, 25, and 29. **Estimated time:** 6–8 hours.
...
build("phase5_rag/25a_measured_rag_baseline.ipynb", cells)
