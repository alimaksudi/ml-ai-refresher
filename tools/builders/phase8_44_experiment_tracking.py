...
cells.append(md(r"""# Notebook 44 — Experiment Tracking
## Core practice introduced after validation; advanced production treatment

**Prerequisites:** Notebooks 09 and 10. Use the basic run-record discipline from
this notebook for every experiment from Notebook 11 onward. Bayesian search,
...
plt.savefig('/tmp/44_experiment_tracking.png', dpi=100, bbox_inches='tight')
plt.close()
print("Figure saved: /tmp/44_experiment_tracking.png")
"""))
...
build("phase8_production/44_experiment_tracking.ipynb", cells)
print("NB44 built.")
